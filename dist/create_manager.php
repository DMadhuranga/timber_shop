        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Enter ID number" id="ID" required/>
                            <label class="text-danger" id="idErr"></label>
                        </div>
                        <div class="form-group">
                ...
                <div class="card-footer">
                    ...
                    <button class="btn btn-primary icon-btn" type="button" onclick="show()"><i class="fa fa-fw fa-lg fa-check-circle"></i>Register</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-default icon-btn" href="create_manager.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    /*function checkId(id){
        ...
        $.ajax({
            ...
            success: function(msg){
                if (msg == true){
                    idErr = "National ID number is already in Use" ;
                    //error = true;
                    return true;
                }else{
                    return false;
    ...
    function updateDb(role,fname,lname,email,address,id,gender){
        var updateDb = true;
        //alert("running");
        $.ajax({
            type: "POST",
    ...
    function show(){
        ...
        if (error == 0){
            updateDb(1,fname,lname,email,address,id,gender);
